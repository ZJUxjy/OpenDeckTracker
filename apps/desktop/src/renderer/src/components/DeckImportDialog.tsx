  ...
  return (
    <Dialog.Root open={open} onOpenChange={onOpenChange}>
      <Dialog.Portal>
        ...
        <Dialog.Content className="fixed left-1/2 top-1/2 z-50 -translate-x-1/2 -translate-y-1/2 w-[500px] max-w-[95vw] bg-overlay-elevated backdrop-blur-xl border border-border rounded-md text-text">
