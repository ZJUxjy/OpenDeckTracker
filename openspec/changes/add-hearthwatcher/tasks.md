...
- [ ] 1.4 Commit scaffold with `git commit -m "feat: scaffold hearthwatcher package"` after verifying only intended scaffold files are staged.
...
- [ ] 2.7 Commit parser work with `git commit -m "feat: parse hearthstone power log events"`.
...
- [ ] 3.6 Commit tailer and discovery work with `git commit -m "feat: tail hearthstone log files"`.
...
- [ ] 4.4 Commit loading-screen parser with `git commit -m "feat: parse hearthstone loading screen state"`.
...
- [ ] 5.9 Commit reducer work with `git commit -m "feat: reduce power log events into entity state"`.
...
- [ ] 6.6 Commit core integration with `git commit -m "feat: ingest log-derived tracker entities"`.
...
- [ ] 7.4 Commit watcher orchestration with `git commit -m "feat: orchestrate hearthwatcher event stream"`.
...
- [ ] 8.5 Commit desktop integration with `git commit -m "feat: connect hearthwatcher to desktop tracker"`.
...
- [ ] 9.4 Manually start Hearthstone, enter a match, and verify watcher diagnostics show `ready` then live events from `Power.log`.
