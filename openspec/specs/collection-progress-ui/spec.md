# collection-progress-ui Specification

## Purpose

Renderer-side affordances for the Collection route: the two-view navigable surface (Set Grid + Set Detail), 5-column tile layout, category tab bar, filter affordances, card cell with ownership states, and rarity→dust derivation.
