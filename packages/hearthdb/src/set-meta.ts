...
// each new expansion launch). The current list reflects the Year of
// the Pegasus rotation announced in the 2024 Blizzard blog post.
//
...
export const STANDARD_SET_CODES: readonly string[] = [
  ...
  'SET_1980', // [2025 expansion — update name when confirmed]
] as const;
...
export const SET_LABELS: Record<string, { 'en-US': string; 'zh-CN': string }> = {
  ...
  SET_1980: { 'en-US': 'Cataclysm',                 'zh-CN': '大灾变' },
  ...
  SET_1946: { 'en-US': 'Emerald Dream',             'zh-CN': '翡翠梦境' },
  SET_1952: { 'en-US': "The Lost City",             'zh-CN': '失落之城' },
  SET_1957: { 'en-US': 'Traveler',                  'zh-CN': '旅人' },
  ...
  // SET_1904, SET_1941, SET_1961 — skipped (0 collectible cards).
};
